<template>
  <form class="home" @submit="onSubmit">
    <CostForm />
    <div class="btn_wrap">
      <BaseButton title="Cancel" type="base" size="medium" />
      <BaseButton title="Save as Draft" type="outline" size="medium" />
      <BaseSubmit title="Submit" type="primary" size="medium" />
    </div>
  </form>
</template>
...
<script>
// @ is an alias to /src
import BaseButton from "@/components/atomic/Button.vue";
import BaseSubmit from "@/components/atomic/Submit.vue";
